<template>
  <a-card
    class="tw:relative tw:h-full tw:rounded-xl tw:border tw:border-[#f0f0f0] tw:dark:border-[#434343] tw:transition-all tw:duration-300 tw:ease-out tw:hover:shadow-xl tw:hover:-translate-y-1 tw:hover:border-[#1890ff] tw:dark:bg-[#1a1a1a] group"
    :class="{
    ...
    <div class="tw:flex tw:justify-between tw:items-start tw:mb-3">
      <div class="tw:flex tw:flex-col tw:gap-1">
        <div class="tw:flex tw:items-center tw:gap-1.5 tw:mb-1">
          ...
          <h4
            class="tw:m-0 tw:text-[15px] tw:font-semibold tw:leading-tight tw:text-[#262626] tw:dark:text-white"
          >
            {{ ticket.title }}
          </h4>
        </div>
