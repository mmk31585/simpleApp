    ...
    <a-form layout="vertical">
      <a-row :gutter="[16, 16]">
          ...
          <a-form-item label="وضعیت" class="tw:mb-0">
            ...
            >
              ...
              <a-select-option value="open"
                ><a-tag color="green" class="tw:m-0 tw:text-[11px]">باز</a-tag></a-select-option
              >
              <a-select-option value="in-progress"
                ><a-tag color="orange" class="tw:m-0 tw:text-[11px]"
                  >در حال انجام</a-tag
                ></a-select-option
              >
              <a-select-option value="closed"
                ><a-tag color="default" class="tw:m-0 tw:text-[11px]">بسته</a-tag></a-select-option
              >
            </a-select>
          </a-form-item>
        </a-col>
        ...
        <a-col :xs="24" :sm="12" :md="6">
          <a-form-item label="اولویت" class="tw:mb-0">
            <a-select
              v-model:value="ticketStore.priorityFilter"
            ...
            >
              ...
              <a-select-option value="low"
                ><a-tag color="green" class="tw:m-0 tw:text-[11px]">پایین</a-tag></a-select-option
              >
              <a-select-option value="medium"
                ><a-tag color="orange" class="tw:m-0 tw:text-[11px]">متوسط</a-tag></a-select-option
              >
              <a-select-option value="high"
                ><a-tag color="red" class="tw:m-0 tw:text-[11px]">بالا</a-tag></a-select-option
              >
              <a-select-option value="critical"
                ><a-tag color="purple" class="tw:m-0 tw:text-[11px]">حیاتی</a-tag></a-select-option
              >
            </a-select>
          </a-form-item>
        </a-col>
        ...
        <a-col :xs="24" :sm="12" :md="6">
          <a-form-item label="سرویس" class="tw:mb-0">
            <a-select
              v-model:value="ticketStore.serviceFilter"
      ...
      <div class="tw:mt-4 tw:pt-4 tw:border-t tw:!border-[#f0f0f0] tw:dark:!border-[#434343]">
        ...
        <div class="tw:flex tw:flex-wrap tw:gap-2">
          <a-button
            size="small"
            :type="quickFilter === 'my-tickets' ? 'primary' : 'default'"
          ...
          <a-button
            size="small"
            :type="quickFilter === 'overdue' ? 'primary' : 'default'"
          ...
          <a-button
            size="small"
            :type="quickFilter === 'pinned' ? 'primary' : 'default'"
