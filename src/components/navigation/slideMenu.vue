...
const props = defineProps<{ items: NonNullable<MenuProps['items']>; selectedKeys?: string[]; openKeys?: string[] }>();
defineEmits<{ (e: 'update:selectedKeys', v: string[]): void; (e: 'update:openKeys', v: string[]): void; (e: 'select', p: { key: string }): void }>();
