<template>
  <a-config-provider :theme="themeStore.themeConfig" direction="rtl">
    <a-layout class="tw-h-screen tw-bg-[#bdd2a9] dark:tw-bg-[#0b1f2a]">
      <a-layout-sider :width="260" theme="dark" class="tw-bg-[#1f2937]">
